...
window.onload = function() {
    $("#ol").html(`<center><div id="inst"><h3>Welcome!<br> Let's check how well is your memory!<br></h3>INSTRUCTIONS-<br/><br/><li>To flip a block you can click on it.</li><li>If two blocks you clicked are not similar, they will be flipped back.</li><p style="font-size:20px; padding-top: 19px;">Select one of the modes to start the game</p></div><button onclick="start(3, 4)">3 x 4</button> <button onclick="start(4, 4)" style="w">4 x 4</button><button onclick="start(4, 5)">4 x 5</button><button onclick="start(5, 6)">5 x 6</button><button onclick="start(6, 6)">6 x 6</button></center>`);
}
