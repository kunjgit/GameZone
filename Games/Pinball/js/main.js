...
var recordedDataString = localStorage.getItem("PinballData");
var recordedData = {};
if (recordedDataString) {
	recordedData = JSON.parse(recordedDataString);
}
recordedData.soundOn = true;

game = new Game(controls, recordedData);
renderer = new Renderer(document.getElementById("c"), document.getElementById("o"), document.getElementById("s"), game);
