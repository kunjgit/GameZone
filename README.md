![GirlScript Season of Code](https://github.com/pankaj-bind/GameZone/blob/main/assets/images/GSSoC.png)
...
1. Create your game folder within the `Games` folder, following the naming convention mentioned in the [CONTRIBUTING GUIDELINE](./CONTRIBUTING.md).
