...
This repository also provides one such platform where contributors come over and put their ideas of new games and make our website as interactive as they can!
...
* Raise an issue to add a new game or to enhancement a game (Have a look at a few things you have to take care during raising the issue )
...
* Having your code in the repository
  ...
  - Add your code files (index.html,style.css,script.js) to your game folder
  - Create a `README.md` file in your folder and add all the functionalities and how you can play that game in that README file, also include screenshots of the working game and a video of a game explaining (if required).
...
- And you are done!
- I will review your code and I will merge your code to the main branch of this repository and you will be notified of the same
- If you have queries in the basic flow of GitHub learn it from [CONTRIBUTING GUIDELINE](./.github/CONTRIBUTING_GUIDELINE.md)
...
- Learn all about the development process and all information you need to contribute to our project
- If you are having basic queries make sure you check out resources there
