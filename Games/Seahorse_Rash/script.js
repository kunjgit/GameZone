window.addEventListener('load', function () {
  ...
  class Game {
    ...
    update(deltaTime) {
      ...
      this.particles = this.particles.filter(particle => !particle.makrkedForDeletion);
      this.explosions.forEach(explosion => explosion.update(deltaTime));
      this.explosions = this.explosions.filter(explosion => !explosion.makrkedForDeletion);
